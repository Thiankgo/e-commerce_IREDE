            ...
            <div className="header-browser h-[190px] bg-blue-900">
                <div className="w-[100%] h-[100%] m-auto flex p-8 flex-col justify-between align-middle">
                    <div className="flex justify-between">
                        ...
                        <SearchBar />
                        <Link to="/cadastrar">
                            <button className="text-[16px] font-[600] w-[120px] h-[40px] text-slate-100 mr-4">Cadastre-se</button>
                        </Link>
                        <Link to="/login">
                            <button className="mr-4 text-[16px] font-[600] rounded w-[120px] h-[40px] text-slate-100 bg-orange-500">Entrar</button>
                        </Link>
